...
/**
 * Class GercpayService.
 *
 * @package Gercpay\Payment\Controller\Url
 */
class GercpayService extends Action implements CsrfAwareActionInterface
{
    /** @var PageFactory */
    ...
    public function execute()
    {
        ...
        $paymentMethod = $this->_objectManager->create('Gercpay\Payment\Model\Gercpay');
