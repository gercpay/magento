...
namespace Gercpay\Payment\Block\Widget;
...
use Gercpay\Payment\Model\Gercpay;

/**
 * Class Redirect
 * @package Gercpay\Payment\Block\Widget
 */
class Redirect extends Template
{
    ...
    {
        $baseUrl = $this->getUrl("gercpay/url");

        //print_R ($baseUrl);die;
        return "{$baseUrl}gercpaysuccess";
    }
    ...
    public function setTemplate($template)
    {
        ...
        if ($method && $method->getCode() === Gercpay::METHOD_CODE) {
