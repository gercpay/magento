...
class GercPay_Payment_Model_Gercpay extends Mage_Payment_Model_Method_Abstract
{
    /**
     * @var string
     */
    protected $_code = 'gercpay_payment';

    /**
     * @var string
     */
    protected $_formBlockType = 'gercpay_payment/form';
    ...
    {
        return Mage::getUrl('gercpay_payment/redirect', array('_secure' => true));
    }
    ...
    public function getFormFields()
    {
        ...
        $description = Mage::helper('gercpay_payment')->__('Payment by card on the site') . ' ' .
        ...
        $callback_url = Mage::getUrl('gercpay/response', array('_secure' => true));
        ...
        $fields['signature'] = Mage::helper('gercpay_payment')->getRequestSignature($fields);
    ...
    public function getButton()
    {
        $button = "<div style='position:absolute; top:50%; left:50%; margin:-40px 0 0 -60px; '>" .
            ...
            "<script type=\"text/javascript\">
                ...
                function subform(){ document.getElementById('GercPayForm').submit(); }
            </script>";
